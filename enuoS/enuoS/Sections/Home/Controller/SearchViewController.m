...
//        [self.navigationController.navigationBar setBackgroundImage:[[UIImage alloc] init] forBarMetrics:UIBarMetricsDefault];
    ...
    //self.tableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth, kScreenHeigth)];
...
- (void)creatTabeleView{
    ...
    //self.tableView.frame = CGRectMake(0, 0, kScreenWidth, self.keyDic.count *25);
...
- (void)requestKeyData{
    ...
    NSDictionary *headBody = @{@"type":self.sumMark,@"search_val":searchView.ZZSearch.text};
...
- (void)handleWithKeyData:(NSDictionary *)data{
    if ([data[@"data"]isKindOfClass:[NSArray class]]) {
        ...
        self.tableView.frame = CGRectMake(0, 20, kScreenWidth, kScreenHeigth);
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    if (tableView == self.tableView) {
        ...
        searchView.ZZSearch.text = cell.textLabel.text;
        self.tableView.hidden = YES;
