...
- (void)loadString
{
    ...
    // 1. URL 定位资源,需要资源的地址
    NSString *urlStr = @"http://www.enuo120.com/index.php/phone/patient/exam";
...
{
    NSString *str = @"javascript:function setHide(){$('.am-breadcrumb').hide();$('header').hide();$('footer').hide();}setHide();";
