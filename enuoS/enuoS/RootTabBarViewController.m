...
- (void)creatViewController{
    ...
    minNc.tabBarItem = [[UITabBarItem alloc]initWithTitle:@"个人中心" image:[[UIImage imageNamed:@"灰色个人"]imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:[[UIImage imageNamed:@"绿色个人"]imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
